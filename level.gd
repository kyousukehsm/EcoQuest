...
# Hide the pause menu
		# Optionally free the pause_menu instance if only needed temporarily
		# pause_menu.queue_free()  # Uncomment this if you want to create a new instance each time
		# pause_menu = null  # Clear reference if freed
