...
@onready var aliya: Aliya = $Aliya  # Reference to the Aliya node
...
@export var aliya_dialogue: Array = [
	...
	"Lalakbayin mo ang tatlong lugar sa ngayon",
	"Gubat, Daan, at aakyat sa isang malaking Puno",
	"Magagamit mo ang mga tools na meron ka",
